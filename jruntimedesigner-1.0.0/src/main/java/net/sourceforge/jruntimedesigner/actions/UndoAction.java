...
public class UndoAction extends AbstractWidgetAction {
  public static final String NAME = "Undo";

  public UndoAction(final JRuntimeDesignerController controller) {
  ...
  protected void updateActionState() {
    setEnabled(controller.getUndoManager().canUndo() && controller.isDesignMode());
  }
