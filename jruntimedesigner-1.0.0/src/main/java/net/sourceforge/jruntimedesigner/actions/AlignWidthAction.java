...
public class AlignWidthAction extends AbstractWidgetAction {
  public static final String NAME = "AlignWidth"; 
  
  public AlignWidthAction(final JRuntimeDesignerController controller) {
  ...
  public void doAction(ActionEvent e) throws Exception {
    ...
    for(IWidgetHolder widget : selectionManager.getSelectedWidgets()) {
      ...
      widget.resizeWidget(new Dimension(guideSize.width, widget.getWidgetSize().height));
    }
    controller.setDirty();
  }
