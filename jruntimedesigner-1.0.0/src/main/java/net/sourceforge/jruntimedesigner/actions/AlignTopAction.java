...
public class AlignTopAction extends AbstractWidgetAction {
  public static final String NAME = "AlignTop";

  public AlignTopAction(final JRuntimeDesignerController controller) {
  ...
  public void doAction(ActionEvent e) throws Exception {
    ...
    for(IWidgetHolder widget : selectionManager.getSelectedWidgets()) {
      ...
      widget.moveWidget(new Point(widget.getWidgetLocation().x, guideWidget.getWidgetLocation().y));
    }
    controller.setDirty();
  }
}
