...
public class AlignSizeAction extends AbstractWidgetAction {
  public static final String NAME = "AlignSize"; 
  
  public AlignSizeAction(final JRuntimeDesignerController controller) {
  ...
  public void doAction(ActionEvent e) throws Exception {
    ...
    for(IWidgetHolder widget : selectionManager.getSelectedWidgets()) {
      ...
      widget.resizeWidget(new Dimension(guideSize.width, guideSize.height));
    }
    controller.setDirty();
  }
}
