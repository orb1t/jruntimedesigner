...
public class MoveForwardsAction extends AbstractWidgetAction {
  public static final String NAME = "MoveForwards";
  private WidgetHolder widgetHolder;

  public MoveForwardsAction(WidgetHolder widgetHolder) {
    super(NAME, widgetHolder.getController());
    this.widgetHolder = widgetHolder;
  }

  public MoveForwardsAction(final JRuntimeDesignerController controller) {
